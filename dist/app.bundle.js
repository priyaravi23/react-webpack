!(function(t) {
  function e(e) {
    for (var n, o, i = e[0], u = e[1], c = 0, s = []; c < i.length; c++)
      (o = i[c]),
  ...
  function(module, __webpack_exports__, __webpack_require__) {
    ...
    (function(module) {
      var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0),
        ...
        react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37),
      ...
      const Warning = react__WEBPACK_IMPORTED_MODULE_0___default.a.lazy(() =>
        __webpack_require__.e(1).then(__webpack_require__.bind(null, 86))
      );
        ...
        constructor(...t) {
          super(...t),
            ...
            _defineProperty(this, "increment", () => {
              this.setState(t => ({ count: t.count + 1 }));
            }),
      ...
      (__webpack_exports__.a = _default),
        ...
        reactHotLoader &&
          (reactHotLoader.register(
            Warning,
            "Warning",
            "/Users/Priya/Documents/github/react-webpack/src/App.js"
          ),
          reactHotLoader.register(
            App,
            "App",
  ...
  function(t, e, n) {
    ...
    var r = n(27),
      ...
      i = n(19),
      u = n(17),
      c = n(4)("isConcatSpreadable");
    t.exports = function t(e, n, a, s, f, l, p, d) {
      for (var _, v, h = f, y = 0, b = !!p && u(p, d, 3); y < s; ) {
        if (y in a) {
          if (
            ((_ = b ? b(a[y], y, n) : a[y]),
            (v = !1),
            o(_) && (v = void 0 !== (v = _[c]) ? !!v : r(_)),
            v && l > 0)
          )
            h = t(e, n, _, i(_.length), h, l - 1) - 1;
          else {
  ...
  function(t, e, n) {
    for (
      ...
      var h,
        ...
        m = u[y],
        g = m && m.prototype;
      if (g && (g[f] || c(g, f, p), g[l] || c(g, l, y), (a[y] = p), b))
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, _, v, h, y) {
      a(n, e, _);
      var b,
        m,
        g,
        ...
        x = !1,
        P = t.prototype,
        w = P[l] || P["@@iterator"] || (v && P[v]),
        L = w || E(v),
        S = v ? (M ? E("entries") : L) : void 0,
        C = ("Array" == e && P.entries) || w;
      if (
        (C &&
          (g = f(C.call(new t()))) !== Object.prototype &&
          g.next &&
          (s(g, O, !0), r || "function" == typeof g[l] || u(g, l, d)),
        M &&
          w &&
          "values" !== w.name &&
          ((x = !0),
  ...
  function(t, e, n) {
    ...
    var u = function t() {
      return t.shouldWrapWithAppContainer
        ? function(t) {
            return function(e) {
              return o.createElement(i, null, o.createElement(t, e));
            };
          }
        : function(t) {
            return t;
  ...
  function(t, e, n) {
    ...
    function a(t, e) {
      for (var n = {}, r = [], o = 0; o < t.length; o++) {
        ...
        -1 !== l
          ? (u[l].references++, u[l].updater(p))
          : u.push({ identifier: f, updater: h(p, e), references: 1 }),
          r.push(f);
      }
      return r;
    }
